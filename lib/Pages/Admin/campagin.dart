...
import 'package:pura_new/component/addCampagin.dart';
import '../../commonPage/header.dart';
import '../../component/addUser.dart';
import '../../constants/constant.dart';
import '../../widget/text.dart';

class Campagin extends StatefulWidget {
  const Campagin({super.key});

  @override
  State<Campagin> createState() => _CampaginState();
}

class _CampaginState extends State<Campagin> {
  List result = [];
