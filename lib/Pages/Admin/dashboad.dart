...
const primaryColor = Color.fromARGB(255, 11, 157, 147);
const canvasColor = Color.fromARGB(255, 11, 157, 147);
const scaffoldBackgroundColor = Color.fromARGB(255, 255, 255, 255);
const accentCanvasColor = Color.fromARGB(255, 84, 242, 213);
const white = Colors.white;
final actionColor = Color.fromARGB(255, 83, 222, 203).withOpacity(0.6);
